...
const App = {
  ...
  init() {
    ...
    this.initUpload();
    this.initActions();
    // CDN-dependent features: only init if libraries loaded
    if (typeof Pickr !== 'undefined') this.initColorPicker();
    else Utils.el('colorPickerContainer').innerHTML = '<input type="color" id="fallbackColor" value="#FFFFFF" onchange="App.currentColor=this.value;App.doReplaceColor()">';
  },
